...
public class OrderRepositoryTests {
	...
	public void testUpdateOrderTracks() {
		...
		OrderTrack orderTrackNew  = new OrderTrack();
		orderTrackNew.setOrder(order);
		orderTrackNew.setUpdatedTime(new Date());
		orderTrackNew.setStatus(OrderStatus.NEW);
		orderTrackNew.setNotes(OrderStatus.NEW.defaultDescription());
		...
		OrderTrack pacakagedTrack  = new OrderTrack();
		pacakagedTrack.setOrder(order);
		pacakagedTrack.setUpdatedTime(new Date());
		pacakagedTrack.setStatus(OrderStatus.PACKAGED);
		pacakagedTrack.setNotes(OrderStatus.PACKAGED.defaultDescription());
		...
		orderTracks.add(orderTrackNew);
		orderTracks.add(processingTrack);
		orderTracks.add(pacakagedTrack);
