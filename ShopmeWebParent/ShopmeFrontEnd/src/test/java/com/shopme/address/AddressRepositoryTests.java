...
//		assertThat(updatedAddress.getPhoneNumber()).isEqualTo(phoneNumber);
	...
	public void testSetDefault() {
		repo.setDefaultAddress(2);
		repo.setDefaultAddress(8);
	}
	
	@Test
	public void testSetNon() {
		repo.setNonDefaultForOthers(0, 41);
	}
	
	@Test
	public void getDefault() {
		Address address = repo.findDefaultByCustomer(106);
		System.out.println(address);
	}
	
	@Test
	public void delete() {
		repoOrder.deleteById(7);
		repoOrder.deleteById(8);
	}
